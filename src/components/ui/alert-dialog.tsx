...
// Reaproveita Radix Dialog como base de um AlertDialog simples (sem dependência extra).
...
>(({ className, ...props }, ref) => (
  <button ref={ref} className={cn(buttonVariants({ variant: "destructive" }), className)} {...props} />
));
